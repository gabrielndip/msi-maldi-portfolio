...
```{r pca-analysis, echo=TRUE, message=TRUE, warning=FALSE, eval=FALSE}
source("scripts/06_pca_analysis.R")
```

```{r pca-figures, echo=FALSE, results='asis', eval=FALSE}
...
```{r pca-summary, echo=FALSE, eval=FALSE}
...
```{r extra-analysis, echo=TRUE, message=TRUE, warning=FALSE, eval=FALSE}
source("scripts/07_extra_analysis.R")
```

```{r extra-analysis-output, echo=FALSE, results='asis', eval=FALSE}
